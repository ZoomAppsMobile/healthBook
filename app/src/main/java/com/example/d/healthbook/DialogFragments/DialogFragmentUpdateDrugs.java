...
public class DialogFragmentUpdateDrugs extends BaseDialogFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            data =(Event_Data) getArguments().getSerializable("date");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.dialog_fragment_add_drugs2, null);
        ...
        edquantityDrugs.setText("2");
        eddurationET.setText(String.valueOf(data.getDuration()));
        startDate_ED.setText(String.valueOf(data.getDate()));
        admissiontimeETcalendar.setText(String.valueOf(data.getTimes()));
        edperiodET.setText("1");
...
//
    ...
    public void saveTakingDrugs(String type, String title, String text, String date, String quantityDrugs,
        ...
        ((CalendarActivity) getActivity()).updateNewTakingDrugs(type, title, text, date, quantityDrugs,
                period, duration, times,data.getId());
        dismiss();
    }
